...
def call(body) {
  ...
  timeout(time: 180, unit: 'MINUTES') {
    ...
    withMavenEnv {
      ...
      sbt = {
        wrap([$class: 'ConfigFileBuildWrapper', managedFiles: [[fileId: 'a451ec64-34b3-4ebc-9678-0198a2a130d5', replaceTokens: false, targetLocation: "${pwd()}/./settings.xml", variable: '']]]) {
